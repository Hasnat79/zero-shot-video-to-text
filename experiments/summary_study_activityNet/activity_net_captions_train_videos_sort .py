"""
Checked downloadable(from youtube) videos count for ActivityNet captions train set
...
with open('AN_caps_train_sumamry_videdo_ids.json') as f:
	AN_train_summary_video_ids = json.load(f)
print(len(AN_train_summary_video_ids))
...
for id, key in enumerate(videos):
	...
	if k in AN_train_summary_video_ids:
		# take video
		video = videos[key]
